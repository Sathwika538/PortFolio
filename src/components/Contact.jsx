...
function Contact(){
 ...
 if (/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(details.user_email))
  ...
  <div className="container row formss ">
   <div className=" col-md-4 " style={{paddingTop:"180px",
                                       marginLeft:"250px"
                                      }}>
          <Lottie animationData={animationData} />;
        </div>
  <div className="container row col-md-8" style={{paddingTop:"160px",
                                                  position: "absolute",
                                                  right: "-100px",
  ...
  <form action="#" autocomplete="on" ref={form} onSubmit={sendEmail}>
      ...
      <input  style={{padding:"5px"}}  class="name-box" type="text" name="user_name" value={details.user_name} placeholder="Name" autoComplete="off" required onChange={handleChange} /><br />
    
      <label style={{padding:"5px"}} >Email</label><br />
      <input  style={{padding:"5px"}} class="email-box" type="email" name="user_email" value={details.user_email} placeholder="Email" autoComplete="off" required onChange={handleChange}/><br />
      
      <label style={{padding:"5px"}} >Message</label><br />
      <textarea  style={{padding:"5px"}} class="message-box" placeholder="Message" name="message" value={details.message} autoComplete="off" required onChange={handleChange}/><br />
      <input  style={{padding:"5px"}} class="submit-button" type="submit" value="Send" ></input>
      <Snackbar
        open={open}
